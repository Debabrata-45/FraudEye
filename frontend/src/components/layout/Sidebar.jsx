...
function NavItem({ item, collapsed }) {
  ...
  return (
    ...
    >
      ...
      {collapsed && (
        <span
          className="fe-tooltip left-full ml-3 top-1/2 -translate-y-1/2 pointer-events-none
      ...
      <div className="flex-shrink-0 border-t border-[#0F1F35]">
        <AnimatePresence initial={false}>
          {!collapsed && (
            ...
            >
              <span className="fe-live-dot w-1.5 h-1.5" />
              <span className="text-[11px] text-[#22C55E] font-medium flex-1">
